...
.DESCRIPTION
    ...
    PowerShell session after placing the operator-approved, signed wintun.dll
...
# Verify the deployment artifact before using it. SHPH also asks the Windows
# loader to require a signed runtime when the native adapter opens.
